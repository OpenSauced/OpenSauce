              ...
              <div className="col-6 d-flex flex-wrap">
              ...
              </div>
                {
                  recipe._id in myRecipes ?
                    <div className="col-6 d-flex flex-wrap"><div className="w-100 btn btn-primary recipe_card-like_button recipeCardBtn">OWNED RECIPE</div></div> : recipe._id in savedRecipes ?
