  ...
  return (
    <li className="col-xs-12 col-sm-4 recipe_card-cont">
      <div className="recipe_card-box">
        ...
        <h2 className="recipe_card-title"><a href={`/viewrecipe/${recipe._id}`}>{recipe.title}</a></h2>
        <p className="recipe_card-desc">{recipe.description}</p>
        <div className="row flex-items-xs-center recipe_card-fork_like-cont">
          <a href={`/addrecipe?recipe=${recipe._id}`} className="recipe_card-fork_button col-xs-4">Fork Recipe</a>
