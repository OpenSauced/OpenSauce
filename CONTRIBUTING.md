...
1. Clone down the master to your local machine
1. Create a branch with a your name and a number followed by what you are implementing
  - use descriptive text like 'bug' or 'feature' in the branch name 
1. Make commits to your feature branch. 
  - again use descriptive text describing what you've done with the code 
1. When you've finished with your fix or feature:
```
  git pull --rebase origin master
```
  - fix any merge conflicts before pushing to origin <yourbranchname>
